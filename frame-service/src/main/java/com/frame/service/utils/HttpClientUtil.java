...
public class HttpClientUtil {
    ...
    public static String sendGetRequestByJava(String reqURL, Map<String, Object> params, String decodeCharset){
        ...
        LOGGER.info("请求的地址为：" + reqURL + sendData.toString());
        return sendGetRequest(reqURL + sendData.toString(), decodeCharset);
    }
